...
def unit_dynamic_testing(deviceId, apk_path, atg_json, deeplinks_json, log_save_path, test_time=10, reinstall=True):
    visited_rate = []
    ...
    path_planner.log_visited_rate(visited_rate, path=log_save_path)
    print("visited rate OK")
    return


def unit_dynamic_testing_package(deviceId, apk_path, atg_json, deeplinks_json, log_save_path, packageName, test_time=300):
    visited_rate = []
